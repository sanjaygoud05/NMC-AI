    ...
    <Sidebar className="bg-sidebar-background">
      <SidebarHeader className="h-14 px-4 flex items-center justify-start border-b border-sidebar-border w-full">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-semibold text-sidebar-foreground leading-tight">SIH26099</h1>
          ...
          <SidebarGroupContent>
            <SidebarMenu className="gap-0">
              {analyticsNavItems.map((item, index) => (
                <SidebarMenuItem key={item.title} className="animate-slide-in-left opacity-0 [animation-fill-mode:forwards] border-b border-sidebar-border m-0 p-0" style={{ animationDelay: `${(index + 7) * 50}ms` }}>
                  <SidebarMenuButton asChild className="h-10 m-0 p-0">
                    <NavLink 
                      to={item.url} 
                      className="flex items-center justify-start gap-3 px-5 h-10 w-full rounded-none text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-all duration-200"
          ...
          <SidebarGroupContent>
            <SidebarMenu className="gap-0">
              {systemNavItems.map((item, index) => (
                <SidebarMenuItem key={item.title} className="animate-slide-in-left opacity-0 [animation-fill-mode:forwards] border-b border-sidebar-border m-0 p-0" style={{ animationDelay: `${(index + 11) * 50}ms` }}>
                  <SidebarMenuButton asChild className="h-10 m-0 p-0">
                    <NavLink 
                      to={item.url} 
                      className="flex items-center justify-start gap-3 px-5 h-10 w-full rounded-none text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-all duration-200"
